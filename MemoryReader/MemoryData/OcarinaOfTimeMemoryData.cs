...
namespace MajoraAutoItemTracker.MemoryReader.MemoryData
{
    ...
    class OcarinaOfTimeMemoryDataObserver : AbstractMemoryDataObserver<OcarinaOfTimeItemLogicPopertyName>
    {
        ...
        public override void BindAllEvent(Action<Tuple<OcarinaOfTimeItemLogicPopertyName, object>> replaySubject)
        {
            HasDekuStick.Subscribe(value => replaySubject(new Tuple<OcarinaOfTimeItemLogicPopertyName, object>(OcarinaOfTimeItemLogicPopertyName.Deku_Stick, value)));
            HasDekuNut.Subscribe(value => replaySubject(new Tuple<OcarinaOfTimeItemLogicPopertyName, object>(OcarinaOfTimeItemLogicPopertyName.Deku_Nut, value)));
            HasBomb.Subscribe(value => replaySubject(new Tuple<OcarinaOfTimeItemLogicPopertyName, object>(OcarinaOfTimeItemLogicPopertyName.Bomb, value)));
            HasBow.Subscribe(value => replaySubject(new Tuple<OcarinaOfTimeItemLogicPopertyName, object>(OcarinaOfTimeItemLogicPopertyName.Bow, value)));
            HasFireArrow.Subscribe(value => replaySubject(new Tuple<OcarinaOfTimeItemLogicPopertyName, object>(OcarinaOfTimeItemLogicPopertyName.Fire_Arrow, value)));
            HasDinFire.Subscribe(value => replaySubject(new Tuple<OcarinaOfTimeItemLogicPopertyName, object>(OcarinaOfTimeItemLogicPopertyName.Din_Fire, value)));
            HasSlingshot.Subscribe(value => replaySubject(new Tuple<OcarinaOfTimeItemLogicPopertyName, object>(OcarinaOfTimeItemLogicPopertyName.Fairy_Slingshot, value)));
            HasOcarina.Subscribe(value => replaySubject(new Tuple<OcarinaOfTimeItemLogicPopertyName, object>(OcarinaOfTimeItemLogicPopertyName.Ocarina, value)));
            HasBombchu.Subscribe(value => replaySubject(new Tuple<OcarinaOfTimeItemLogicPopertyName, object>(OcarinaOfTimeItemLogicPopertyName.Bombchu, value)));
            HasHookshot.Subscribe(value => replaySubject(new Tuple<OcarinaOfTimeItemLogicPopertyName, object>(OcarinaOfTimeItemLogicPopertyName.Hookshot, value)));
            HasIceArrow.Subscribe(value => replaySubject(new Tuple<OcarinaOfTimeItemLogicPopertyName, object>(OcarinaOfTimeItemLogicPopertyName.Ice_Arrow, value)));
            HasFaroreWind.Subscribe(value => replaySubject(new Tuple<OcarinaOfTimeItemLogicPopertyName, object>(OcarinaOfTimeItemLogicPopertyName.Farore_Wind, value)));
            HasBoomerang.Subscribe(value => replaySubject(new Tuple<OcarinaOfTimeItemLogicPopertyName, object>(OcarinaOfTimeItemLogicPopertyName.Boomerang, value)));
            HasLensOfTruth.Subscribe(value => replaySubject(new Tuple<OcarinaOfTimeItemLogicPopertyName, object>(OcarinaOfTimeItemLogicPopertyName.Lens_of_Truth, value)));
            HasMagicBean.Subscribe(value => replaySubject(new Tuple<OcarinaOfTimeItemLogicPopertyName, object>(OcarinaOfTimeItemLogicPopertyName.Magic_Bean, value)));
            HasMegatonHammer.Subscribe(value => replaySubject(new Tuple<OcarinaOfTimeItemLogicPopertyName, object>(OcarinaOfTimeItemLogicPopertyName.Megaton_Hammer, value)));
            HasLightArrow.Subscribe(value => replaySubject(new Tuple<OcarinaOfTimeItemLogicPopertyName, object>(OcarinaOfTimeItemLogicPopertyName.Light_Arrow, value)));
            HasNayruLove.Subscribe(value => replaySubject(new Tuple<OcarinaOfTimeItemLogicPopertyName, object>(OcarinaOfTimeItemLogicPopertyName.Nayru_Love, value)));
            HasBottle1.Subscribe(value => replaySubject(new Tuple<OcarinaOfTimeItemLogicPopertyName, object>(OcarinaOfTimeItemLogicPopertyName.Bottle_1, value)));
            HasBottle2.Subscribe(value => replaySubject(new Tuple<OcarinaOfTimeItemLogicPopertyName, object>(OcarinaOfTimeItemLogicPopertyName.Bottle_2, value)));
            ...
            HasStoneOfAgony.Subscribe(value => replaySubject(new Tuple<OcarinaOfTimeItemLogicPopertyName, object>(OcarinaOfTimeItemLogicPopertyName.Stone_of_Agony, value)));
            HasGerudoCard.Subscribe(value => replaySubject(new Tuple<OcarinaOfTimeItemLogicPopertyName, object>(OcarinaOfTimeItemLogicPopertyName.Gerudo_Card, value)));
            HasGoldSkulltula.Subscribe(value => replaySubject(new Tuple<OcarinaOfTimeItemLogicPopertyName, object>(OcarinaOfTimeItemLogicPopertyName.Gold_Skulltula, value)));
            HasDekuShield.Subscribe(value => replaySubject(new Tuple<OcarinaOfTimeItemLogicPopertyName, object>(OcarinaOfTimeItemLogicPopertyName.Deku_Shield, value)));
            ...
            HasZoraTunic.Subscribe(value => replaySubject(new Tuple<OcarinaOfTimeItemLogicPopertyName, object>(OcarinaOfTimeItemLogicPopertyName.Zora_Tunic, value)));
            HasHeartContainer.Subscribe(value => replaySubject(new Tuple<OcarinaOfTimeItemLogicPopertyName, object>(OcarinaOfTimeItemLogicPopertyName.Heart_Container, value)));
            HasMagic.Subscribe(value => replaySubject(new Tuple<OcarinaOfTimeItemLogicPopertyName, object>(OcarinaOfTimeItemLogicPopertyName.Magic, value)));
            HasKokiriBoots.Subscribe(value => replaySubject(new Tuple<OcarinaOfTimeItemLogicPopertyName, object>(OcarinaOfTimeItemLogicPopertyName.Kokiri_Boots, value)));
            HasIronBoots.Subscribe(value => replaySubject(new Tuple<OcarinaOfTimeItemLogicPopertyName, object>(OcarinaOfTimeItemLogicPopertyName.Iron_Boots, value)));
            HasHoverBoots.Subscribe(value => replaySubject(new Tuple<OcarinaOfTimeItemLogicPopertyName, object>(OcarinaOfTimeItemLogicPopertyName.Hover_Boots, value)));
            HasKokiriEmerald.Subscribe(value => replaySubject(new Tuple<OcarinaOfTimeItemLogicPopertyName, object>(OcarinaOfTimeItemLogicPopertyName.Kokiri_Emerald, value)));
            HasGoronRuby.Subscribe(value => replaySubject(new Tuple<OcarinaOfTimeItemLogicPopertyName, object>(OcarinaOfTimeItemLogicPopertyName.Goron_Ruby, value)));
            HasZoraSapphire.Subscribe(value => replaySubject(new Tuple<OcarinaOfTimeItemLogicPopertyName, object>(OcarinaOfTimeItemLogicPopertyName.Zora_Sapphire, value)));
            HasForestMedallion.Subscribe(value => replaySubject(new Tuple<OcarinaOfTimeItemLogicPopertyName, object>(OcarinaOfTimeItemLogicPopertyName.Forest_Medallion, value)));
            HasFireMedallion.Subscribe(value => replaySubject(new Tuple<OcarinaOfTimeItemLogicPopertyName, object>(OcarinaOfTimeItemLogicPopertyName.Fire_Medallion, value)));
            HasWaterMedallion.Subscribe(value => replaySubject(new Tuple<OcarinaOfTimeItemLogicPopertyName, object>(OcarinaOfTimeItemLogicPopertyName.Water_Medallion, value)));
            HasSpiritMedallion.Subscribe(value => replaySubject(new Tuple<OcarinaOfTimeItemLogicPopertyName, object>(OcarinaOfTimeItemLogicPopertyName.Spirit_Medallion, value)));
            HasShadowMedallion.Subscribe(value => replaySubject(new Tuple<OcarinaOfTimeItemLogicPopertyName, object>(OcarinaOfTimeItemLogicPopertyName.Shadow_Medallion, value)));
            HasLightMedallion.Subscribe(value => replaySubject(new Tuple<OcarinaOfTimeItemLogicPopertyName, object>(OcarinaOfTimeItemLogicPopertyName.Light_Medallion, value)));
            HasMinuetOfForest.Subscribe(value => replaySubject(new Tuple<OcarinaOfTimeItemLogicPopertyName, object>(OcarinaOfTimeItemLogicPopertyName.Minuet_of_Forest, value)));
            HasBoleroOfFire.Subscribe(value => replaySubject(new Tuple<OcarinaOfTimeItemLogicPopertyName, object>(OcarinaOfTimeItemLogicPopertyName.Bolero_of_Fire, value)));
            HasSerenadeOfWater.Subscribe(value => replaySubject(new Tuple<OcarinaOfTimeItemLogicPopertyName, object>(OcarinaOfTimeItemLogicPopertyName.Serenade_of_Water, value)));
            HasRequiemOfSpirit.Subscribe(value => replaySubject(new Tuple<OcarinaOfTimeItemLogicPopertyName, object>(OcarinaOfTimeItemLogicPopertyName.Requiem_of_Spirit, value)));
            HasNocturneOfShadow.Subscribe(value => replaySubject(new Tuple<OcarinaOfTimeItemLogicPopertyName, object>(OcarinaOfTimeItemLogicPopertyName.Nocturne_of_Shadow, value)));
            HasPreludeOfLight.Subscribe(value => replaySubject(new Tuple<OcarinaOfTimeItemLogicPopertyName, object>(OcarinaOfTimeItemLogicPopertyName.Prelude_of_Light, value)));
            HasZeldaLullaby.Subscribe(value => replaySubject(new Tuple<OcarinaOfTimeItemLogicPopertyName, object>(OcarinaOfTimeItemLogicPopertyName.Zelda_Lullaby, value)));
            HasEponaSong.Subscribe(value => replaySubject(new Tuple<OcarinaOfTimeItemLogicPopertyName, object>(OcarinaOfTimeItemLogicPopertyName.Epona_Song, value)));
            HasSariaSong.Subscribe(value => replaySubject(new Tuple<OcarinaOfTimeItemLogicPopertyName, object>(OcarinaOfTimeItemLogicPopertyName.Saria_Song, value)));
            HasSunSong.Subscribe(value => replaySubject(new Tuple<OcarinaOfTimeItemLogicPopertyName, object>(OcarinaOfTimeItemLogicPopertyName.Sun_Song, value)));
            HasSongOfTime.Subscribe(value => replaySubject(new Tuple<OcarinaOfTimeItemLogicPopertyName, object>(OcarinaOfTimeItemLogicPopertyName.Song_of_Time, value)));
            HasSongOfStorms.Subscribe(value => replaySubject(new Tuple<OcarinaOfTimeItemLogicPopertyName, object>(OcarinaOfTimeItemLogicPopertyName.Song_of_Storms, value)));
        }
    }
}
